...
public class RemoveListItemToShoppingListCommandHandler : DirtyCommandHandler<ShoppingListEntity, RemoveListItemToShoppingListCommand, Result<ShoppingListRecord>>
{
    private readonly IEventRepository _eventRepository;
    private readonly ICheckpointRepository<ShoppingListEntity> _shoppingListCheckpointRepository;
    private readonly IMapper _mapper;
    private readonly IUserService _userService;
    private readonly IValidator<RemoveListItemToShoppingListCommand> _validator;
    private readonly ILogger<RemoveListItemToShoppingListCommandHandler> _logger;

    public RemoveListItemToShoppingListCommandHandler(
        ...
        IMapper mapper,
        IValidator<RemoveListItemToShoppingListCommand> validator,
        ILogger<RemoveListItemToShoppingListCommandHandler> logger) : base(eventRepository, shoppingListUpdateConfig.Value, daprService, logger)
    {
    ...
    public override async Task<Result<ShoppingListRecord>> Handle(RemoveListItemToShoppingListCommand command, CancellationToken cancellationToken)
    {
    ...
    private static string FailedToCreateMessage(RemoveListItemToShoppingListCommand command) =>
